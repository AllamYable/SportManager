...
func PushEquipe(db *sql.DB) {
	...
	_, err := db.Exec(`
        ...
        ('Paprika', 'M. Poivre', 6, 1, 7, 200, '2018-01-01'),
        ('Parmesan', 'M. Bri', 5, 3, 8, 200, '2019-06-20'),
        ('Epitech', 'M. Jérôme', 2, 16, 18, 50, '2024-08-09'),
        ('Epsi', 'M. Croquette', 4, 0, 5, 300, '1961-03-30');
    `)
	if err != nil {
	...
	_, err = db.Exec(`
        ...
        ('Cesi', 'M. Allan & M. Yannis', 0, 0, 0, 200);
    `)
	if err != nil {
